      ...
      while (isRunning)
      {
        ...
        switch (input)
        {
          case '1':
            ...
            {
              Print("NO ENDPOINT WAS ADDED", PrintType.ERROR);
            }
            break;
          case '2':
            //! Alters endpoint
            try
            {
              // TODO: (Improvement) Ask if should keep same value on editing field
            ...
            {
              Print("NO ENDPOINT WAS ALTERED", PrintType.ERROR);
            }
            break;
          case '3':
            //! Deletes endpoint
